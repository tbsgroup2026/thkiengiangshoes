...
| **04. CN-CI (Cải tiến liên tục)** | [CNCIWrapper.tsx](file:///d:/Work/KG-KAIZEN/web/src/modules/ci/CNCIWrapper.tsx), [CIModule.tsx](file:///d:/Work/KG-KAIZEN/web/src/modules/ci/CIModule.tsx), [KaizenDetailModal.tsx](file:///d:/Work/KG-KAIZEN/web/src/modules/ci/KaizenDetailModal.tsx), [README.md](file:///d:/Work/KG-KAIZEN/web/src/modules/ci/README.md) | [organizationTree.ts](file:///d:/Work/KG-KAIZEN/web/src/modules/ci/organizationTree.ts), `permissionEngine.ts` | [cnciData.ts](file:///d:/Work/KG-KAIZEN/web/src/lib/cnciData.ts), `organizationTree.ts` | `/api/ci-kaizen`, `/api/ci-kaizen/stats`, `/api/ci-kaizen/expert-evaluations`, `/api/ci-kaizen/rate` |
